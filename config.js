window.khesht = {
    config: {
        ...
        baseUrl: '//cdn.rawgit.com/sajjad-shirazy/Khesht/v1.1/',//change it to CDN url of your files
        paths: {
			...
			fileinput:	'//cdn.rawgit.com/kartik-v/bootstrap-fileinput/tree/v3.0.0',
			// ---
            khesht: 	'//cdn.rawgit.com/sajjad-shirazy/Khesht/v1.1/khesht.min',
            pages: 		'pages.min',
