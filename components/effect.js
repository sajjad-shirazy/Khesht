    ...
    var Effect = (function (_super) {
        ...
        Effect.prototype.ajaxes = function () {
            return $.extend(_super.prototype.ajaxes.call(this), {
                data: U.getJSON(require.toUrl('pcd_root/effects/effect.json'), null, null, null, { cache: false })
            });
        };
        Effect.prototype.start = function () {
            ...
            var fileInput = new FileInput({
                ...
                uploadAsync: false,
                initialPreview: $.map(this.data, function (value) {
                    return D.div().append(D.img({ src: require.toUrl(['pcd_root/effects/', value, '.svg'].join('')) }).addClass('file-preview-image')).html();
                }),
                initialPreviewConfig: $.map(this.data, function (value, index) {
                    return {
                        caption: value,
                        width: "120px",
