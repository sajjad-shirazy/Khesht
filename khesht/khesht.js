...
define('khesht/utils',["require", "exports", 'khesht/app', "jquery"], function (require, exports, APP) {
    var Utils = (function () {
        function Utils() {
        }
        ...
        * - paths automaticly match with requireJS configs
        */
        Utils.getJSON = function (url, data, success, options) {
            if (options === void 0) { options = {}; }
            options = $.extend({
                dataType: 'json',
                url: url,
...
/// <amd-dependency path="jquery"/>
define('khesht/dom',["require", "exports", 'khesht/utils', "jquery"], function (require, exports, U) {
    var DOM = (function () {
        function DOM() {
        }
...
define('khesht/eventdispatcher',["require", "exports"], function (require, exports) {
    /**
...
define('khesht/element',["require", "exports", 'khesht/dom', 'khesht/eventdispatcher'], function (require, exports, D, EventDispatcher) {
    var Element = (function (_super) {
        ...
        Element.prototype.appendProperty = function (name, control) {
            if (name) {
                this[name] = control.attr('name', name);
            }
            this.append(control);
            return control;
        };
...
define('khesht/form',["require", "exports", 'khesht/utils', 'khesht/dom', 'khesht/element'], function (require, exports, U, D, Base) {
    var Form = (function (_super) {
        __extends(Form, _super);
        function Form(attr) {
            _super.call(this, D.form($.extend({ action: require.toUrl('api') + '/', method: 'POST' }, attr)));
            this.inputTypes = 'input,select,textarea';
            this.addHidden('callback', U.URL);
        ...
        Form.prototype.addInput = function (name, control, required) {
            ...
            if (name) {
                this[name + '_wrapper'] = control;
            }
            this.appendProperty(name, control.children().addBack().find(this.inputTypes).data('required', required));
            return control;
        };
        Form.prototype.addHidden = function (name, value) {
            this.append(this[name] = D.hidden({ name: name, value: value }));
        };
        Form.prototype.addSubmit = function () {
            return D.button().appendTo(this.dom).click(this.submit.bind(this));
        };
        ...
        Form.prototype.formData = function () {
            var data = {};
            this.dom.serializeArray().map(function (x) {
                data[x.name] = x.value;
            });
            return data;
        };
...
define('khesht/component',["require", "exports", 'khesht/utils', 'khesht/element'], function (require, exports, U, Element) {
...
define('khesht/page',["require", "exports", 'khesht/utils', 'khesht/dom', 'khesht/component'], function (require, exports, U, D, Base) {
